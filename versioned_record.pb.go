...
func (x *VersionedRecord) GetAccessV1() *v1.AccessRecord {
	if x != nil {
		if x, ok := x.Record.(*VersionedRecord_AccessV1); ok {
			return x.AccessV1
		}
	}
	return nil
...
type VersionedRecord_AccessV1 struct {
	AccessV1 *v1.AccessRecord `protobuf:"bytes,1,opt,name=access_v1,json=accessV1,proto3,oneof"` // AccessRecord access_v2 = 2;
}

func (*VersionedRecord_AccessV1) isVersionedRecord_Record() {}
...
var file_versioned_record_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x49, 0x0a, 0x0f, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x65, 0x64, 0x52, 0x65,
	0x63, 0x6f, 0x72, 0x64, 0x12, 0x2c, 0x0a, 0x09, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x76,
	0x31, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73,
	0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x48, 0x00, 0x52, 0x08, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73,
	0x56, 0x31, 0x42, 0x08, 0x0a, 0x06, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x42, 0x1c, 0x5a, 0x1a,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x7a, 0x69, 0x74, 0x61, 0x64,
	0x65, 0x6c, 0x2f, 0x6c, 0x6f, 0x67, 0x67, 0x69, 0x6e, 0x67, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_versioned_record_proto_goTypes = []any{
	...
	(*v1.AccessRecord)(nil), // 1: AccessRecord
}
var file_versioned_record_proto_depIdxs = []int32{
	1, // 0: VersionedRecord.access_v1:type_name -> AccessRecord
